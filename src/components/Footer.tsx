...
import { FileText, LayoutDashboard, Edit, User, Mail, Phone, MapPin, Globe } from "lucide-react";
    ...
    <footer className="bg-gray-50 py-12 border-t border-gray-200">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-bold">DraftLinker</h3>
            </div>
            <p className="text-gray-600 text-sm mb-4">
              Create, edit, and save your professional letters directly to Google Drive with our intuitive platform.
            </p>
            ...
            <ul className="space-y-2">
              {links.map((link) => (
                <li key={link.name}>
                  <Link
                    to={link.path}
                    className="text-gray-600 hover:text-primary transition-colors flex items-center text-sm"
                  >
                    {link.icon} {link.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-600 hover:text-primary transition-colors text-sm">Help Center</a>
              </li>
              <li>
                <a href="#" className="text-gray-600 hover:text-primary transition-colors text-sm">Documentation</a>
              </li>
              <li>
                <a href="#" className="text-gray-600 hover:text-primary transition-colors text-sm">API Reference</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start">
                ...
                <a href="mailto:support@draftlinker.com" className="text-gray-600 hover:text-primary transition-colors">
              ...
              <li className="flex items-start">
                ...
                <a href="https://www.draftlinker.com" className="text-gray-600 hover:text-primary transition-colors">
                  www.draftlinker.com
                </a>
              </li>
            </ul>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          <p>&copy; {currentYear} DraftLinker. All rights reserved.</p>
